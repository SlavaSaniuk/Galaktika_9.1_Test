.LinkForm 'REESBVIP_zar_IBAN' Prototype is 'REESBVIP'
.Group 'Реестры по перечислению в сбербанк'
.NameInList 'MC Перечисления по заработной плате(версия WEB) IBAN'
.p 60
.var
  Npp_R:Integer
  D1   : double;
...
.begin
  ...
  D6 := 'Швайкова Ю.Н.';
  D7 := 'Перечисление зарплаты рабочих и служащих';
  D8 := 000;
  D9 := Cur_Date;
  D10:= 'K';
